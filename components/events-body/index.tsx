...
export default function IbaramReportPage() {
  ...
  return (
    <main className={styles.wrapper}>
      ...
      <div className={styles.tabs}>
        ...
        <button className={`${styles.tab} ${activeTab === "report" ? styles.active : ""}`} onClick={() => setActiveTab("report")}>
          Applicants Report
        </button>
      </div>
        ...
        {activeTab === "events" && (
          <main className={styles.container}>
            ...
            <section className={styles.section}>
              ...
              <p>
                A welcome address was delivered by the President of the Federation of Ibaram Students Union (FISU), <strong>Mr. Daisi Bibire</strong>. He welcomed Kabiyesi and the
                entire community to the epoch-making event.
              </p>
              <p>
                He expressed profound gratitude to the Founder of the Joseph Adaramola Foundation for consistently supporting youth education through financial assistance to
                deserving students in Ibaram. He appealed to students to be more committed to union activities.
              </p>
            </section>
            ...
            <section className={styles.section}>
              ...
              <p>
                ...
                <strong> His Royal Majesty, Oba Raphael Oluwasegunota Atibioke (Ajiya III)</strong>. He emphasized that education is the key to success and admonished youths to
                shun all vices.
              </p>
              <p>
            ...
            <section className={styles.section}>
              ...
              <p>
                The FISU President and executives discussed how the education summit organized by <strong>Mr. Akin Adaramola</strong>, including an excursion to FUTA, positively
                changed students’ perception of academics.
              </p>
              <p>
