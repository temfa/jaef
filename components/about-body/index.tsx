  ...
  return (
    <div className={styles.container}>
      <div className={styles.first}>
        ...
        <div className={styles.content}>
          ...
          <p>
            ...
            father's (Pa Joseph Adaramola) for his love and commitment to the education of his children during his life time .
          </p>
          <p>
      ...
      <div className={styles.second}>
        <div className={styles.content}>
          <p>
            The Joseph Adaramola Foundation was established as a platform to offer educational financial assistance to qualify indigenes of Ibaram-Akoko who are students in
